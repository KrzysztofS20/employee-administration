    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <p class="mb-4">wszyscy kursanci biorący udział w szkoleniu - SDA |<a href="https://datatables.net/"
                            ...
                            <table class="table action-panel" id="dataTable">
                                ...
                                <tr>
                                    ...
                                    <td><a href="#" role="button" class="btn btn-success btn-circle" data-toggle="modal"
                                           data-target="#skills"><i class="fas fa-check"></i></a></td>
                                    <td><a href="<c:url value="/editPerson"/>" class="btn-right btn btn-primary">Edytuj</a></td>
                                </tr>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="card shadow mb-4">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <h4 class="small font-weight-bold">Wzorce projektowe <span
                                                        ...
                                                        <h4 class="small font-weight-bold">Bazy danych SQL <span
                                                        ...
                                                        <h4 class="small font-weight-bold">Hibernate JPA <span
                                                                class="float-right">80%</span></h4>
                                                        <div class="progress mb-4">
                                                            <div class="progress-bar bg-info" role="progressbar"
                                                                 style="width: 80%" aria-valuenow="80" aria-valuemin="0"
                                                        ...
                                                        <h4 class="small font-weight-bold">JSP <span
                                                                class="float-right">80%</span></h4>
                                                        <div class="progress mb-4">
                                                            <div class="progress-bar bg-info" role="progressbar"
                                                                 style="width: 80%" aria-valuenow="80" aria-valuemin="0"
                                                        ...
                                                        <h4 class="small font-weight-bold">Thymeleaf <span
                                                                class="float-right">80%</span></h4>
                                                        <div class="progress mb-4">
                                                            <div class="progress-bar bg-info" role="progressbar"
                                                                 style="width: 80%" aria-valuenow="80" aria-valuemin="0"
